    ...
    <div class="wrap">
        <div v-if="!isShow">
            <!-- <van-nav-bar title="通讯录">
                <img src="https://wx.phxinfo.com.cn/img/wechat/Add.png" style="width:30rpx;height:30rpx;" alt="" slot="left" @click="getAddMail">
            </van-nav-bar> -->
            <div class="search">
                <van-search :value="value" placeholder="搜索" @click="getSearch" />
            </div>
            <div class="container">
                <!-- <div class="header">
                    <div class="box" @click="getRouter">
                        <p class="imgWrap">
                            <img src="https://wx.phxinfo.com.cn/img/wechat/Phone.png" alt="">
                        </p>
                        <p>手机联系人</p>
                    </div>
                    <div class="box">
                        <p class="imgWrap">
                            <img src="https://wx.phxinfo.com.cn/img/wechat/Myfriend.png" alt="">
                        </p>
                        <p>凤凰好友</p>
                    </div>
                    <div class="box">
                        <p class="imgWrap">
                            <img src="https://wx.phxinfo.com.cn/img/wechat/MyGroup.png" alt="">
                        </p>
                        <p>我的群组</p>
                    </div>
                    <div class="box">
                        <p class="imgWrap">
                            <img src="https://wx.phxinfo.com.cn/img/wechat/Corporate.png" alt="">
                        </p>
                        <p>企业广场</p>
                    </div>
                </div> -->
