    ...
    <div class="wrap">
        ...
        <div class="center"  v-if="!isShow&&!repeatShow">
           <picker @change="pickerSchedule" :value="index" :range="array">
            ...
            <!-- 会议室 -->
            <div class="row" v-if="index==1&&conference.name">
                <p class="icon">
                    <i class="iconfont icon-huiyishi"></i>
                </p>
                <p class="cont">{{conference.name}}</p>
                <p>
                    <i-icon type="close" color="#666666" size="20" @click="getDelConference" />
                </p>
            </div>
            ...
            <div class="row" @click="getRepeat" v-if="index==0&&repeatisShow">
                ...
                <p class="cont">每天重复</p>
                <p>
                    <i-icon type="close" size="20" color="#666666" @click.stop="getRepeatShow" />
                </p>
            </div>
            ...
            <div class="row" v-if="descriptionShow">
                ...
                <p>
                    <i-icon type="close" size="20" color="#666666" @click.stop="getDescriptionShow" />
                </p>
            </div>
            <div class="iconRow">
                ...
                <div class="box" @click="getRepeatShow" v-if="index==0&&!repeatisShow">
                    <p>
                        <i class="iconfont icon-zhongfu"></i>
                    </p>
                    <p class="name">重复</p>
...
export default {
    ...
    methods:{
        ...
        getCurrent(startTime,endTime){
            ...
            this.hours = `${date.getHours()}时${date.getMinutes()}分`;
            ...
            this.endHours = `${endDate.getHours()}时${endDate.getMinutes()}分`;
        ...
        // 重复
        getRepeatShow(){
            this.repeatisShow = !this.repeatisShow;
        },
        getNoticeShow(){
