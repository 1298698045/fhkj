          ...
          <div class="record"  :class="index!=0?'top':''" v-for="(item,index) in list.attendData" :key="index">
            ...
            <div class="rightCont">
              ...
              <div class="toWrap">
                ...
                <p class="toUpdate" v-if="item.CheckTime!=''&&item.AbnormalCode=='1'||item.AbnormalCode=='2'" @click="getSeeComment(item)">查看备注<i-icon type="enter" /></p>
              </div>
              <!-- 缺卡 -->
    ...
    getChooseImage(){
      ...
      wx.chooseImage({
        ...
        success (res) {
          ...
          wx.uploadFile({
              url: "https://wx.phxinfo.com.cn/rest?method="+'file.attachfiles.upload'+'&SessionKey=' + that.sessionkey+'&pid='+that.AttendanceEmpId+'&objTypeCode='+'30090',
      ...
      .rightCont{
        ...
        .roundWrap{
          ...
          .round{
            ...
            align-items: center;
            margin-right: 30px;
            box-shadow: 0rpx 10rpx 30rpx rgba(34, 155, 250, 0.6);
            .time{
              font-size: 31rpx;
              opacity: .6;
            }
          ...
          .round.zaotui{
            ...
            box-shadow: 0rpx 10rpx 30rpx rgba(254, 150, 61, 0.6);
          }
          .round.waiqin{
            background: #0ebc7f;
            // box-shadow: 0rpx 70rpx 117rpx 0rpx rgba(21, 190, 131, 0.3);
            box-shadow: 0rpx 10rpx 30rpx rgba(21, 190, 131, 0.6);
          }
        }
        .clockInAdress{
          width: 100%;
